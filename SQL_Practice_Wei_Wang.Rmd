...
![Lynda Course completion proof](~/SQL Practice/Lynda Course Proof.png)

2. SQL Teaching completion screen shots.

![SQL Teaching completion part 1](~/SQL Practice/SQL Teaching complete Part 1.png)
![SQL Teaching completion part 2](~/SQL Practice/SQL Teaching complete Part 2.png)
...
```{r}
# Select pclass, survived, average age column from titanic_Wei database and group it by pclass and survived.
...
```{r}
# Select pclass, survived and average age column from titanic_Wei database who has to be survived and group them by pclass and survived.
dbGetQuery(con2, "select pclass, 
                  survived, 
...
```{r}
# Select the name, pclass, survived and age column from titanic_Wei whose name consist "sen" in it.
...
```{r}
# Select name, pclass, survived and age column from titanic_Wei whose name should start with Jakob.
dbGetQuery(con2, "select name, 
                  pclass, 
                  survived, 
...
```{r}
# Select the name, pclass, survived and age column from titanic_Wei database whose name has to have ivar in it.
dbGetQuery(con2, "select name, 
                  pclass, 
                  survived, 
...
```{r}
# Select the name, pclass, survived and age column from titanic_Wei database whose name has to have ivar as an individual word in it.
dbGetQuery(con2, "select name, 
                  pclass, 
                  survived, 
                  age from titanic_Wang where name regexp ',.*Ivar.*$';")
